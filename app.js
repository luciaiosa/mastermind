...
function playMastermind() {
    ...
    function getCorrectProposedCombination(colors, combinationLength) {
        ...
        do {
            proposedCombination = console.readString(`Propose a combination of 4 colors: `);
        ...
        function showError(errorCodeInCombination, COLORS) {
            const errorStrings = [
                ...
                `Wrong colors, they must be: ${arrayToString(COLORS)}`,
    ...
    function showBoard(attempts, blacksAndWhites) {
        ...
        for (let i = 0; i < attempts.length; i++) {
            console.writeln(`${attempts[i]}  --> ${blacksAndWhites[i][0]} black and ${blacksAndWhites[i][1]} white`);
        }
    }
